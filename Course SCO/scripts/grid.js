...
function writeQuestion() {
	...
	strHTML += "<img id='submit_' src='" + donePath + "' onmouseover = 'this.src=\"../sysimages/done_2.png\"' onmouseout='this.src=\"../sysimages/done_0.png\"'  alt='DONE button'  width='90' height='36' border='0' /></a></div>"
	strHTML += "</td></tr></table>"
